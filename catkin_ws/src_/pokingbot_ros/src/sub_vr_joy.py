...
class subvrandpub(object):
    ...
    def __init__(self):
        # robot1
        self.sub_xy1 = rospy.Subscriber("vr1/joystick_xy", Float32MultiArray, self.callback_xy1)
        self.pub_twist1 = rospy.Publisher("/robot1/husky_velocity_controller/cmd_vel",Twist, queue_size=10)
        # # robot2
        self.sub_xy2 = rospy.Subscriber("vr2/joystick_xy", Float32MultiArray, self.callback_xy2)
        self.pub_twist2 = rospy.Publisher("/robot2/husky_velocity_controller/cmd_vel",Twist, queue_size=10)
        # # robot3
        self.sub_xy3 = rospy.Subscriber("vr3/joystick_xy", Float32MultiArray, self.callback_xy3)
        self.pub_twist3 = rospy.Publisher("/robot3/husky_velocity_controller/cmd_vel",Twist, queue_size=10)
