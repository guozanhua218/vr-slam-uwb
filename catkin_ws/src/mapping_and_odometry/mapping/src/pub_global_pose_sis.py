...
# gp1 = np.array([1.8, 1.8, 0.33])
# gp2 = np.array([2.4, 1.8, 0.33]) 
# gp3 = np.array([1.8, 2.4, 0.33])
# tags = [0, 1, 2]
# A_points = {0: gp1, 1: gp2, 2: gp3}

gp1 = np.array([1.8, 1.8, 0.59]) 
gp2 = np.array([2.155, 1.834, 0.59])
gp3 = np.array([1.8, 2.417, 0.59])
tags = [0, 1, 2]
A_points = {0: gp1, 1: gp2, 2: gp3}


# if switch position 2 and 3
# gp1 = np.array([1.8, 1.8, 0.33])
# gp2 = np.array([1.8, 2.4, 0.33]) 
# gp3 = np.array([2.4, 1.8, 0.33])
# tags = [0, 1, 2]
# A_points = {0: gp1, 1: gp2, 2: gp3}

# gp1 = np.array([1.8, 1.8, 0.33])
# gp2 = np.array([1.8, 2.417, 0.33]) 
# gp3 = np.array([2.155, 1.834, 0.33])
# tags = [0, 1, 2]
# A_points = {0: gp1, 1: gp2, 2: gp3}
...
class PubGlobalPose(object):
    ...
    def __init__(self):
        ...
        self.sub_at = rospy.Subscriber("/locobot27/tag_detections", AprilTagDetectionArray, self.apriltags_cb, queue_size=20)
