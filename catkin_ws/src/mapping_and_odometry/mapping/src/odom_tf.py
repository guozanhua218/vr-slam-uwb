...
class Wheel_tf:
    ...
    def cb_odom(self, msg):
        if self.origin_matrix is None:
            ...
            self.origin_matrix = tf.transformations.inverse_matrix(self.origin_matrix)
        else:
            new_matrix = tf.transformations.quaternion_matrix([msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w])
